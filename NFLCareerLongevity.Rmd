...
linearRB <- glm(ThreeYrLeft ~ ., train_dataRB, family = "binomial")
summary(linearRB)
#AIC: 1290.1
```
...
linearRB1 <- glm(ThreeYrLeft ~ Age * Pts * AllTD*G, train_dataRB, family = "binomial")
summary(linearRB1)
#AIC: 1257.7

predictions <- predict(linearRB1, newdata = test_dataRB, type = "response")
