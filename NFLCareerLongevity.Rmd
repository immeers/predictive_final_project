...
# Perform stratified sampling
 split_dat <- stratified(final, # Set dataset
                         group = c("YearsRemaining", "FirstName", "LastName", "Pos"), # Set variables to use for stratification
...
train_dat$YearsRemaining <- as.numeric(as.character(train_dat$YearsRemaining))


linear <- lm(YearsRemaining ~ Age + Pts, train_dat)
summary(linear)

preds <- predict(linear, test_dat)
t <- table(preds, test_dat$YearsRemaining) # Create table
